...
final_effective_lrate=0.002
pnorm_input_dim=3000
pnorm_output_dim=300
relu_dim=250  # you can use this to make it use ReLU's instead of p-norms.
...
shuffle_buffer_size=50000 # This "buffer_size" variable controls randomization of the samples
...
feat_type=lda  # or set to 'lda' to use LDA features.
